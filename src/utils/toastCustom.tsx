...
export const ToastCustom = (
  ...
  return toast.custom(
    (t) => (
      ...
      >
        <div className={`alert ${state === 'error' ? 'bg-red-200' : 'bg-green-200'} items-start border-l-4 ${state === 'error' ? 'border-red-700' : 'border-green-700'}  shadow-lg z-50 sm:right-2 w-80 mx-auto  text-green-900`}>
          <div className="flex gap-3">
            ...
            <div>
              ...
              <div className="text-xs">
                <p className={`mt-1 text-[11px] opacity-70 ${state === 'error'
                  ? 'text-red-600'
                  : 'text-green-600'}`}>
                  {message}
                </p>
