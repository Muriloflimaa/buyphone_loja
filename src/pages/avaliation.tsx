...
export default function Avaliation() {
    return (
        <div className="max-w-7xl my-10">
            <div className="max-w-4xl mx-auto flex flex-col items-center text-PrimaryText text-center gap-4">
                ...
                <span>
                    O seu pedido foi aceito e está sendo processado. Você irá
                    receber uma notificação com os detalhes do pedido no seu
                    e-mail.
                </span>
                <Link href={'/'}>
