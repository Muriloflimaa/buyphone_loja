    ...
    <div className="w-full flex flex-col md:flex-row max-w-5xl mx-auto my-10 p-10 card shadow-lg ">
      <div className="md:w-2/3">
        <div className="flex gap-3 relative">
          ...
          <div className="flex flex-col items-start text-[#201942]">
            ...
            >
              ...
              <FontAwesomeIcon
                icon={faInstagram}
                className="mr-2 w-4 h-4 text-[#201942]"
              />
            </a>
          </div>
        </div>
        <div className="relative md:pr-10 text-center md:text-start mt-4 px-5 md:px-0 text-[#201942]">
          <span>“{depoiment}”</span>
          <FontAwesomeIcon
            icon={faQuoteRight}
            className="text-[#201942]/20 h-8 w-8 absolute left-0 top-0 -mt-4 -ml-3 rotate-180"
          />
        </div>
      </div>
