...
export default function ProductUnavailable({
  ...
  return (
    <form
      className={'form-control gap-2 w-full flex flex-col items-center'}
    ...
    >
      ...
      <button
        onClick={() => name && email && setLoading(true)}
        className={`btn btn-info btn-block text-white ${loading && 'loading'}`}
        type="submit"
      >
        Enviar
      </button>
